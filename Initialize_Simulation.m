...
Sim.mode.mperturbconstant   = 0;
Sim.mode.muncertainty       = 0;
...
Sim.actuator.deflection_limit_deg      = 20;
Sim.actuator.deflection_rate_limit_deg = 150;
...
Sim.wind.turb_sigma  = 2.0;
Sim.wind.turb_length = 150;
Sim.simulation.Sim_Extender = 1;

%% Earth and environment model
Sim.earth.AGRAV   = 9.80675445;
Sim.earth.C20     = -4.8416685e-4;
Sim.earth.GM      = 3.9860044e14;
Sim.earth.WEII3   = 0;
Sim.earth.GW_CLONG = 0;

if Sim.mode.mEarth == 0
    Sim.earth.SMAJOR_AXIS = 6370987.308;
    Sim.earth.REARTH      = 6370987.308;
    Sim.earth.FLATTENING  = 0;
else
    Sim.earth.SMAJOR_AXIS = 6378137.0;
    Sim.earth.REARTH      = 6370987.308;
    Sim.earth.FLATTENING  = 3.33528106e-3;
end

%% ========================================================================
% Earth rotation
Sim.earth.WEII3 = 0; %Kept at zero for trimming

%% ========================================================================
% Vehicle properties

% Vehicle mass properties
Sim.vehicle.mass.total_full = 136077;
Sim.vehicle.mass.fuel_full = 81646;

Sim.vehicle.mass.structural = ...
    Sim.vehicle.mass.total_full - Sim.vehicle.mass.fuel_full;

% Current fuel and vehicle mass
Sim.vehicle.mass.fuel = ...
    Sim.vehicle.fuel.fraction * Sim.vehicle.mass.fuel_full;

Sim.vehicle.mass.current = ...
    Sim.vehicle.mass.structural + Sim.vehicle.mass.fuel;

Sim.vehicle.inertia.IBBB0 = [ ...
    1.5730e+06  0            3.8000e+05;
    0           3.1600e+07   0;
    3.8000e+05  0            3.2540e+07 ];

Sim.vehicle.inertia.IBBB1 = [ ...
    1.1800e+06  0            2.4000e+05;
    0           1.9625e+07   0;
    2.4000e+05  0            2.0200e+07 ];

Sim.vehicle.inertia.IBBBr = ...
    Sim.vehicle.fuel.fraction     * Sim.vehicle.inertia.IBBB0 + ...
    (1-Sim.vehicle.fuel.fraction) * Sim.vehicle.inertia.IBBB1;

Sim.vehicle.geometry.refa = 557.42;
Sim.vehicle.geometry.refb = 24.38;
Sim.vehicle.geometry.refc = 22.86;

Sim.vehicle.acowl = 27.27;
